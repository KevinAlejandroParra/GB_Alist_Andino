...
const subItemTemplates = [
  ...
  { 
    item_number: '3', 
    question_text: "CONDICIÓN DE SEGURIDAD  (CUENTA CON CINTURON DE SEGURIDAD)", 
    guidance_text: "Comprobar la seguridad de operación (tiempo, movimientos, sonidos) se complete según las especificaciones del fabricante.",
  }
];
